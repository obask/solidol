...
import {
  ...
  // createComponent,
  // sharedConfig,
  untrack, sharedConfig,
  // mergeProps
} from "../web/core";

import {createComponent, mergeProps} from "../render/component"

import reconcileArrays from "./reconcile";
// import {MountableElement} from "./client";
...
function insertExpression(parent, value, current, marker, unwrapArray) {
  ...
  while (typeof current === "function") { // noinspection JSUnresolvedFunction
    current = current();
  }
